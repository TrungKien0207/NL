   ...
   <div class="collapse navbar-collapse" id="navbarSupportedContent">
      ...
      <li class="nav-item dropdown " style="list-style-type: none;">
         ...
         <div class="dropdown-menu dropdown-menu-right container-item" aria-labelledby="navbarDropdown">
            ...
            @else
               <a class="dropdown-item dd-item" href="login"><img width="40px" class="mr-2" src="https://img.icons8.com/cute-clipart/64/000000/enter-2.png"/>Đăng nhập</a>
               <a class="dropdown-item dd-item" href="signup"><img width="40px" class="mr-2" src="https://img.icons8.com/dusk/64/000000/sign-up.png"/>Đăng kí</a>
            @endif
         </div>
      </li>
   </div>
